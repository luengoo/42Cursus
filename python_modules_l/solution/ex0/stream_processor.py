...
class NumericProcessor(DataProcessor):
	...
	def format_output(self, data: Optional[Any] = None) -> str:
		total: int = sum(self.data)
		avg: float = total / len(self.data)
		return f"Processed {len(self.data)} numeric values, sum={total}, avg={avg}"
...
class TextProcessor(DataProcessor):
	...
	def format_output(self, data: Optional[Any] = None) -> str:
		chars: int = len(self.data)
		words: int = len(self.data.split())
