...
def main_program():
	...
	print(f"Distance between {origin} and {pos1}: {distance_between(origin, pos1): .2f}\n")
	coord_str = "3,4,0"
	print('Parsing coordinates: "3,4,0"')
	parsed_pos = parse_coordinates(coord_str)
	if parsed_pos:
		print(f"Distance between {origin} and {parsed_pos}: {distance_between(origin, parsed_pos):.1f}\n")
