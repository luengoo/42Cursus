...
def all_achievements():
	...
	unique = {'boss_slayer', 'collector', 'first_kill', 'level_10', 'perfectionist', 'speed_demon', 'treasure_hunter'}
...
def main_func():
	...
	player3_ach = {'level_10', 'treasure_hunter', 'boss_slayer', 'speed_demon', 'perfectionist'}

	players = {"Alice": player1_ach, "Bob": player2_ach, "Charlie": player3_ach}
